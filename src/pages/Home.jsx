...
export const Home = () => {
  return (
    <div className='home-container'>
     ...
     <div className='why'> 
     <img className='banner' src="../dist/assets/meditations.png" alt="meditation" />
...
<div className='what'>
  <img className='banner' src="../dist/assets/screen.png" alt="Meditapp timer" />
...
<div className='end'>
  <img className='banner' src="./dist/assets/screen3.png" alt="benefit of meditation" />
  <h3> References </h3>
