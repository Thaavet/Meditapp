...
<div className='what'>
<img className='banner' src={process.env.PUBLIC_URL + 'dist/assets/screen.png'} alt="Meditapp timer" />
...
<div className='end'>
<img className='banner' src={process.env.PUBLIC_URL + 'dist/assets/screen3.png'} alt="benefit of meditation" />
  <h3> References </h3>
