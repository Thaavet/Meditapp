...
export const Home = () => {
  return (
    <div className='home-container'>
     ...
     <div className='why'> 
     <img className='banner' src="./src/images/meditations.png" alt="meditation" />
...
<div className='what'>
  <img className='banner' src="./src/images/screen.png" alt="Meditapp timer" />
...
<div className='end'>
  <img className='banner' src="./src/images/screen3.png" alt="benefit of meditation" />
  <h3> References </h3>
